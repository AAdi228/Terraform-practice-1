...
resource "aws_key_pair" "aadi" {
  key_name   = "aadi"  # Replace with your desired key name
  public_key = file("C:/Users/hi/.ssh/id_ed25519.pub") 
...
resource "aws_instance" "server" {
  ...
  key_name      = aws_key_pair.aadi.key_name
  vpc_security_group_ids = [aws_security_group.cherry.id]
  subnet_id              = aws_subnet.sub1.id
  ...
  connection {
    ...
    private_key = file("C:/Users/hi/.ssh/id_ed25519")  #private key path
    host        = self.public_ip
  }
